...
type IntroSection = { title: string; body: string };

type SeoContentProps = {
  introSections?: IntroSection[];
  showHowTo?: boolean;
  showMinimumWage?: boolean;
  showFaq?: boolean;
};
...
export default function SeoContent({
  introSections,
  showHowTo = true,
  showMinimumWage = true,
  showFaq = true,
}: SeoContentProps) {
  const sections = introSections ?? seoIntroSections;
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-4xl px-4 py-12">
        ...
        {showMinimumWage && <MinimumWageInfographic />}
